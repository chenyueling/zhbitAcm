...
!function($) {
    ...
    $.fn.validation.defaults = {
        validRules : [
			...
			{name: 'username', validate: function(value) {return (!/^[a-zA-Z][a-zA-Z0-9_]{4,15}$/.test(value));}, defaultMsg: '请输入正确账号名。'},
			{name: 'nickname', validate: function(value) {return (!/^[\u0391-\uFFE5A-Za-z0-9]{4,20}$/.test(value));}, defaultMsg: '请输入正确昵称。'}
