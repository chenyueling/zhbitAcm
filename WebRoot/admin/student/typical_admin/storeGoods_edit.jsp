...
<body bgcolor="#F8F8F8">
	<div id="p" class="easyui-panel" title="上传学生店商品" style="padding:10px;">
		<form id="wg_form" class="wg_form">
			<input type="hidden" name="id" value="<s:property value="#request.storeGoods.storeGoodsId"/>"/>
			<div class="wg_item">
				<label>新旧程度</label>
				<div class="wg_input">
			...
			<div class="wg_item">
				...
				<div class="wg_input">
					...
					<b id="type_name"><s:property value="#request.storeGoods.goodsType.parent.name"/>-<s:property value="#request.storeGoods.goodsType.name"/></b>
					<input type="hidden" name="goodsType" value="<s:property value="#request.storeGoods.goodsType.secendLevelTypeId"/>"/>
				</div>
			</div>
			<div class="clear"></div>
			<div class="wg_item">
				...
				<div class="wg_input">
					<input id="name" name="name" type="text" style="width: 400px;" value="<s:property value="#request.storeGoods.name"/>" />
				</div>
			</div>
			<div class="clear"></div>
			<div class="wg_item">
				...
				<div class="wg_input">
					<input id="marketPrice" name="marketPrice" type="text" value="<s:property value="#request.storeGoods.marketPrice"/>" />
				</div>
			</div>
			<div class="clear"></div>
			<div class="wg_item">
				...
				<div class="wg_input">
					<input id="price" name="price" type="text" value="<s:property value="#request.storeGoods.price"/>" />
				</div>
			</div>
			<div class="clear"></div>
			<div class="wg_item">
				...
				<div class="wg_input">
					<input id="count" name="count" type="text" value="<s:property value="#request.storeGoods.count"/>"/>
				</div>
			</div>
			<div class="clear"></div>
			<div class="wg_item">
				...
				<div class="image_cell">
				    <div class="image_body">
				        <a href="javascript:void(0)">
				            <img src="<s:property value="#request.storeGoods.frontImage.path"/>">
				        </a>
				    </div>
				    <div class="image_info">
				        <p>商品封面</p>
				    </div>
				    <div class="cover" style="top: 0px;">
				        <a class="delete" href="javascript:void(0)">删除</a>
				        <a class="setFornt" href="javascript:void(0)" style="display:none;">设为封面</a>
				    </div>
				    <input type="hidden" class="frontImage" name="frontImage" value="<s:property value="#request.storeGoods.frontImage.userImageId"/>"/>
				</div>
				<!-- image front ends -->
				<!-- image list start-->
				<s:iterator value="#request.storeGoods.goodsImage">
					<div class="image_cell">
					    <div class="image_body">
					        <a href="javascript:void(0)">
					    ...
					    <div class="cover" style="top: 0px;">
					        <a class="delete" href="javascript:void(0)">删除</a>
					        <a class="setFornt" href="javascript:void(0)">设为封面</a>
					    </div>
					    <input type="hidden" value="<s:property value="userImageId"/>" name="images">
					</div>
				</s:iterator>
				<!-- image list ends -->
			</div>
			...
			<div class="wg_item">
				...
				<div class="wg_input" style="margin-left:110px;">
					<script type="text/plain" id="content" name="info">
    					<s:property value="#request.storeGoods.info" escape="false"/>
					</script>
				</div>
			...
			<div class="wg_item">
				<div class="wg_input" style="margin-left:110px;margin-top: 10px;">
					<a href="#" id="submit" onclick="javascript:void(0)" class="easyui-linkbutton">更新商品</a>
				</div>
			</div>
			<div class="clear"></div>
...
$(function() {
		...
		//图片展示初始化
		$(".image_cell img").fixParentFirst({width:150, height:150});
		//工具类浮现效果
		$('.image_cell').hover(function(){
			$(".cover", this).stop().animate({top:'-25px'},{queue:false,duration:300});
		}, function() {
		...
		$("input[value='<s:property value="#request.storeGoods.type"/>']").attr('checked', true);
