...
<script type="text/javascript">
	$(function() {
    	...
    	if(url.indexOf("login") < 0){
    		top.location.href = "<%=basePath%>admin/system/association_login.jsp";
    	}
		initLoginForm('#login_form', 'associationadmin/association_login', function() {
			window.location.href = "<%=basePath%>admin/system/association_admin/index.jsp";
		});
	});
</script>
